...
enum EncryptionMethod : uint
{
	...
	//TLSv1_3, // TLS version 1.3 encryption
}
...
public:
	@property bool isOpen() const { return _open; }

	@property bool isSecure() const { return _secure; }

	@property bool isCertVerified() const { return _verified; }

	@property string hostName() const { return _sock.hostName; }
	...
	bool SSLbegin(EncryptionMethod encMethod = EncryptionMethod.TLSv1_2)
	{
		...
		// Verify
		_verified = SSL_get_verify_result(_ssl) == X509_V_OK;
		return _secure;
	}
